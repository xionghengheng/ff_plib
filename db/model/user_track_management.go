...
type UserTrackNodeModel struct {
	...
	// 预体验课id
	PreTrailID int64 `json:"pre_trail_id"` // 预体验课id

	// 预体验课支付成功后，生成的
	TrailPackageID string `json:"trail_package_id"`
	TrailLessonID  string `json:"trail_lesson_id"`

	// 转化成功，用户发生购买课包
	PayPackageID string `json:"pay_package_id"`
}
